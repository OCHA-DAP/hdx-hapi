...
ENDPOINT_ROUTER = '/api/v2/coordination-context/national-risk'
...
@pytest.mark.asyncio
async def test_get_national_risk(event_loop, refresh_db):
    log.info('started test_get_national_risk')
