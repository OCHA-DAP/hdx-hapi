...
async def datasets_view_list(
    ...
    logger.info(f'datasets_view_list called with params: hdx_id={hdx_id}, hdx_stub={hdx_stub}, title={title}, hdx_provider_stub={hdx_provider_stub}, provider_name={provider_name}')
