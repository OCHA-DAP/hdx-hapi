...
async def get_operational_presences(
    ...
    sector_name: Annotated[str, Query(max_length=512, description='Filter the response by sector names, which describe the humanitarian sector to which the operational presence applies. See the <a href="https://FIXTHIS/docs#/humanitarian-response/get_sectors_api_sector_get">sector endpoint</a> for details.')] = None,
    org_acronym: Annotated[str, Query(max_length=32, description='Filter the response by the acronym of the organization to which the operational presence applies. See the <a href="https://FIXTHIS/docs#/humanitarian-response/get_orgs_api_org_get">org endpoint</a> for details')] = None,
    org_name: Annotated[str, Query(max_length=512, description='Filter the response by the name of the organization to which the operational presence applies. See the <a href="https://FIXTHIS/docs#/humanitarian-response/get_orgs_api_org_get">org endpoint</a> for details')] = None,
    ...
    dataset_provider_code: Annotated[str, Query(max_length=128, description='Filter the query by the organizations contributing the source data to HDX. If you want to filter by the organization mentioned in the operational presence record, see the org_name and org_acronym parameters below.')] = None,
