...
DOC_HDX_DATASET_ID = 'A unique and fixed identifier of a Dataset on HDX. A URL in the pattern of https://data.humdata.org/dataset/[hdx_id] will load the dataset page on HDX.'
DOC_HDX_DATASET_NAME = 'The URL-safe name of the dataset as displayed on HDX. This name is unique but can change. A URL in the pattern of https://data.humdata.org/dataset/[hdx_name] will load the dataset page on HDX.'
DOC_HDX_DATASET_TITLE = 'The title of the dataset as it appears in the HDX interface. This name is not unique and can change.'
DOC_HDX_PROVIDER_STUB = 'The code of the provider of the dataset on HDX. A URL in the pattern of https://data.humdata.org/organization/[org stub] will load the provider\'s page on HDX.'
DOC_HDX_PROVIDER_NAME = 'The display name of the provider of the dataset on HDX.'
